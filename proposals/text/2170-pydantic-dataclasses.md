...
- Proposal PR: n/a
- Github Issue: https://github.com/khulnasoft/deepstack/pull/1598
- Deciders: @tholor


## Context and Problem Statement

Originally we implemented Deepstack's primitive based on Python's vanilla `dataclasses`. However, shortly after we realized this causes issues with FastAPI, which uses Pydantic's implementation. We need to decide which version (vanilla Python's or Pydantic's) to use in our codebase.
...
* Pydantic dataclasses are slower. See https://github.com/khulnasoft/deepstack/pull/1598 for a rough performance assessment.
...
* Bad, because it introduces an additional dependency to Deepstack (negligible)
...
* https://github.com/khulnasoft/deepstack/pull/1598
* https://github.com/khulnasoft/deepstack/issues/1593
* https://github.com/khulnasoft/deepstack/issues/1582
* https://github.com/khulnasoft/deepstack/pull/1398
* https://github.com/khulnasoft/deepstack/issues/1232
