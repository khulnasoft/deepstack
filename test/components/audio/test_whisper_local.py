...
from deepstack.dataclasses import Document, ByteStream
...
class TestLocalWhisperTranscriber:
    ...
    def test_to_dict(self):
        ...
        assert data == {
            "type": "deepstack.components.audio.whisper_local.LocalWhisperTranscriber",
            "init_parameters": {
                "model": "large",
    ...
    def test_warmup(self):
        with patch("deepstack.components.audio.whisper_local.whisper") as mocked_whisper:
