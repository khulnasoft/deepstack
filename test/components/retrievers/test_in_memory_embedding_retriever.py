...
from deepstack import Pipeline, DeserializationError
from deepstack.testing.factory import document_store_class
from deepstack.components.retrievers.in_memory.embedding_retriever import InMemoryEmbeddingRetriever
...
class TestMemoryEmbeddingRetriever:
    ...
    def test_to_dict(self):
        ...
        assert data == {
            "type": "deepstack.components.retrievers.in_memory.embedding_retriever.InMemoryEmbeddingRetriever",
            "init_parameters": {
