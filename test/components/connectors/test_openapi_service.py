...
from deepstack.components.connectors import OpenAPIServiceConnector
...
class TestOpenAPIServiceConnector:
    ...
    def test_parse_valid_json_message(self):
        ...
        assert descriptors[0]["arguments"]["requestBody"] == {"q": "deepstack"}
    ...
    def test_for_internal_raw_data_field(self):
        # see https://github.com/khulnasoft/deepstack/pull/6772 for details
    ...
    @patch("deepstack.components.connectors.openapi_service.OpenAPI")
    def test_run(self, openapi_mock, test_files_path):
            ...
            [
                {
                    ...
                    "function": {
                        "arguments": '{"basehead": "main...some_branch", "owner": "khulnasoft", "repo": "deepstack"}',
        ...
        mock_service.call_compare_branches.assert_called_once_with(
            parameters={"basehead": "main...some_branch", "owner": "khulnasoft", "repo": "deepstack"}
        )
