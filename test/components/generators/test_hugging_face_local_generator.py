...
from deepstack.components.generators.hugging_face_local import HuggingFaceLocalGenerator, StopWordsCriteria
from deepstack.utils import ComponentDevice
from deepstack.utils.auth import Secret
from deepstack.utils.hf import HFTokenStreamingHandler


class TestHuggingFaceLocalGenerator:
    @patch("deepstack.utils.hf.model_info")
    ...
    def test_to_dict_default(self, model_info_mock):
        ...
        assert data == {
            "type": "deepstack.components.generators.hugging_face_local.HuggingFaceLocalGenerator",
            "init_parameters": {
    ...
    @patch("deepstack.components.generators.hugging_face_local.pipeline")
    ...
    @patch("deepstack.components.generators.hugging_face_local.pipeline")
    @patch("deepstack.components.generators.hugging_face_local.StopWordsCriteria")
    @patch("deepstack.components.generators.hugging_face_local.StoppingCriteriaList")
