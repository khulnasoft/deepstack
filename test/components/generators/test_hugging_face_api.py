...
from deepstack.components.generators import HuggingFaceAPIGenerator
...
def mock_check_valid_model():
    with patch(
        "deepstack.components.generators.hugging_face_api.check_valid_model", MagicMock(return_value=None)
    ) as mock:
        yield mock
