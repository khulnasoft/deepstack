...
from deepstack.components.generators.chat import HuggingFaceTGIChatGenerator
...
def mock_list_inference_deployed_models():
    with patch(
        "deepstack.components.generators.chat.hugging_face_tgi.list_inference_deployed_models",
        MagicMock(
            return_value=[
...
def mock_check_valid_model():
    with patch(
        "deepstack.components.generators.chat.hugging_face_tgi.check_valid_model", MagicMock(return_value=None)
    ) as mock:
        yield mock
