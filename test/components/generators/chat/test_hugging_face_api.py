...
from deepstack.components.generators.chat import HuggingFaceAPIChatGenerator
from deepstack.dataclasses import ChatMessage, StreamingChunk
from deepstack.utils.auth import Secret
from deepstack.utils.hf import HFGenerationAPIType


@pytest.fixture
def mock_check_valid_model():
    with patch(
        "deepstack.components.generators.chat.hugging_face_api.check_valid_model", MagicMock(return_value=None)
    ) as mock:
        yield mock
