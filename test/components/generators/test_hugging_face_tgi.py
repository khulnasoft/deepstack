...
def mock_list_inference_deployed_models():
    with patch(
        "deepstack.components.generators.hugging_face_tgi.list_inference_deployed_models",
        MagicMock(
...
def mock_check_valid_model():
    with patch(
        "deepstack.components.generators.hugging_face_tgi.check_valid_model", MagicMock(return_value=None)
    ) as mock:
        yield mock
