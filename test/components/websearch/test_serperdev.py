...
from deepstack.components.websearch.serper_dev import SerperDevWebSearch, SerperDevError
...
def mock_serper_dev_search_result():
    with patch("deepstack.components.websearch.serper_dev.requests") as mock_run:
...
class TestSerperDevSearchAPI:
    ...
    def test_to_dict(self, monkeypatch):
        ...
        assert data == {
            "type": "deepstack.components.websearch.serper_dev.SerperDevWebSearch",
            "init_parameters": {
