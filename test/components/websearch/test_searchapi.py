...
from deepstack.components.websearch.searchapi import SearchApiError, SearchApiWebSearch
...
def mock_searchapi_search_result():
    with patch("deepstack.components.websearch.searchapi.requests.get") as mock_get:
...
class TestSearchApiSearchAPI:
    ...
    def test_to_dict(self, monkeypatch):
        ...
        assert data == {
            "type": "deepstack.components.websearch.searchapi.SearchApiWebSearch",
            "init_parameters": {
