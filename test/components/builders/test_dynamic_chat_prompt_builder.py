...
class TestDynamicChatPromptBuilder:
    def test_initialization(self):
        ...
        assert builder.__deepstack_input__._sockets_dict["prompt_source"].type == List[ChatMessage]

        # output is always prompt, but the type is different depending on the chat mode
        assert builder.__deepstack_output__._sockets_dict["prompt"].type == List[ChatMessage]
