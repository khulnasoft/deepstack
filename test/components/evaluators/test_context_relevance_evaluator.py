...
from deepstack.components.evaluators import ContextRelevanceEvaluator
...
class TestContextRelevanceEvaluator:
    ...
    def test_from_dict(self, monkeypatch):
        ...
        data = {
            "type": "deepstack.components.evaluators.context_relevance.ContextRelevanceEvaluator",
            "init_parameters": {
    ...
    def test_run_calculates_mean_score(self, monkeypatch):
        ...
        monkeypatch.setattr("deepstack.components.generators.openai.OpenAIGenerator.run", generator_run)
