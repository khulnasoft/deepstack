...
def mock_check_valid_model():
    with patch(
        "deepstack.components.embedders.hugging_face_tei_text_embedder.check_valid_model", MagicMock(return_value=None)
    ) as mock:
        yield mock
...
class TestHuggingFaceTEITextEmbedder:
    ...
    def test_to_dict(self, mock_check_valid_model):
        ...
        assert data == {
            "type": "deepstack.components.embedders.hugging_face_tei_text_embedder.HuggingFaceTEITextEmbedder",
            "init_parameters": {
