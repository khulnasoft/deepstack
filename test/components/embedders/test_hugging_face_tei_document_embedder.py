...
def mock_check_valid_model():
    with patch(
        "deepstack.components.embedders.hugging_face_tei_document_embedder.check_valid_model",
...
class TestHuggingFaceTEIDocumentEmbedder:
    ...
    def test_to_dict(self, mock_check_valid_model):
        ...
        assert data == {
            "type": "deepstack.components.embedders.hugging_face_tei_document_embedder.HuggingFaceTEIDocumentEmbedder",
            "init_parameters": {
