...
from deepstack.components.embedders import AzureOpenAIDocumentEmbedder
...
class TestAzureOpenAIDocumentEmbedder:
    ...
    def test_to_dict(self, monkeypatch):
        ...
        assert data == {
            "type": "deepstack.components.embedders.azure_document_embedder.AzureOpenAIDocumentEmbedder",
            "init_parameters": {
