...
from deepstack.components.embedders import AzureOpenAITextEmbedder
...
class TestAzureOpenAITextEmbedder:
    ...
    def test_to_dict(self, monkeypatch):
        ...
        assert data == {
            "type": "deepstack.components.embedders.azure_text_embedder.AzureOpenAITextEmbedder",
            "init_parameters": {
    ...
    def test_run(self):
        ...
        embedder = AzureOpenAITextEmbedder(
            azure_deployment="text-embedding-ada-002", prefix="prefix ", suffix=" suffix", organization="DeepstackCI"
        )
