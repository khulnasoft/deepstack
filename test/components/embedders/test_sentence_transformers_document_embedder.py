...
class TestSentenceTransformersDocumentEmbedder:
    ...
    def test_to_dict(self):
        ...
        assert data == {
            "type": "deepstack.components.embedders.sentence_transformers_document_embedder.SentenceTransformersDocumentEmbedder",
            "init_parameters": {
                "model": "model",
    ...
    @patch(
        "deepstack.components.embedders.sentence_transformers_document_embedder._SentenceTransformersEmbeddingBackendFactory"
    )
