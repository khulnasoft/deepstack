...
class TestSentenceTransformersTextEmbedder:
    ...
    def test_to_dict(self):
        ...
        assert data == {
            "type": "deepstack.components.embedders.sentence_transformers_text_embedder.SentenceTransformersTextEmbedder",
            "init_parameters": {
    ...
    @patch(
        "deepstack.components.embedders.sentence_transformers_text_embedder._SentenceTransformersEmbeddingBackendFactory"
    )
