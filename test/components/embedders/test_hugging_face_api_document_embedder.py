...
from deepstack.components.embedders import HuggingFaceAPIDocumentEmbedder
...
def mock_check_valid_model():
    with patch(
        "deepstack.components.embedders.hugging_face_api_document_embedder.check_valid_model",
...
class TestHuggingFaceAPIDocumentEmbedder:
    ...
    def test_to_dict(self, mock_check_valid_model):
        ...
        assert data == {
            "type": "deepstack.components.embedders.hugging_face_api_document_embedder.HuggingFaceAPIDocumentEmbedder",
            "init_parameters": {
                "api_type": HFEmbeddingAPIType.SERVERLESS_INFERENCE_API,
                "api_params": {"model": "BAAI/bge-small-en-v1.5"},
