...
from deepstack.components.converters.output_adapter import OutputAdaptationException
...
class TestOutputAdapter:
    ...
    def test_initialized_with_valid_template_and_output_type(self):
        ...
        assert adapter.__deepstack_output__.output.name == "output"
        assert adapter.__deepstack_output__.output.type == output_type
    ...
    def test_output_adapter_in_pipeline(self):
        ...
        class DocumentProducer:
            ...
            def run(self):
                return {"documents": [{"content": '{"framework": "Deepstack"}'}]}
        ...
        assert result
        assert result["output_adapter"]["output"] == {"framework": "Deepstack"}
