...
from deepstack import Document, default_from_dict, default_to_dict
from deepstack.components.converters.pypdf import CONVERTERS_REGISTRY, DefaultConverter, PyPDFToDocument
...
class TestPyPDFToDocument:
    ...
    def test_to_dict(self, pypdf_converter):
        ...
        assert data == {
            "type": "deepstack.components.converters.pypdf.PyPDFToDocument",
            "init_parameters": {
                "converter": {"type": "deepstack.components.converters.pypdf.DefaultConverter", "init_parameters": {}},
                "converter_name": None,
            },
        }
    ...
    def test_run_with_meta(self, test_files_path, pypdf_converter):
        ...
        with patch("deepstack.components.converters.pypdf.PdfReader"):
