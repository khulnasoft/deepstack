...
class TestTransformersZeroShotTextRouter:
    def test_to_dict(self):
        ...
        assert router_dict == {
            "type": "deepstack.components.routers.zero_shot_text_router.TransformersZeroShotTextRouter",
            "init_parameters": {
    ...
    @patch("deepstack.components.routers.zero_shot_text_router.pipeline")
