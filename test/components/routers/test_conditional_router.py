...
from deepstack.components.routers.conditional_router import NoRouteSelectedException
...
class TestRouter:
    ...
    def test_no_vars_in_output_route_but_with_output_name(self):
        ...
        kwargs = {"streams": [1, 2, 3], "query": "Deepstack"}
    ...
    def test_router_initialized(self, routes):
        ...
        assert set(router.__deepstack_input__._sockets_dict.keys()) == {"query", "streams"}
        assert set(router.__deepstack_output__._sockets_dict.keys()) == {"query", "streams"}
    ...
    def test_router_de_serialization_user_type(self):
        ...
        assert (
            ...
            == "deepstack.dataclasses.chat_message.ChatMessage"
        )
