...
from deepstack import ComponentError, Document
from deepstack.components.rankers.transformers_similarity import TransformersSimilarityRanker
...
class TestSimilarityRanker:
    def test_to_dict(self):
        ...
        assert data == {
            "type": "deepstack.components.rankers.transformers_similarity.TransformersSimilarityRanker",
            "init_parameters": {
                "device": None,
                "top_k": 10,
    ...
    @patch("deepstack.components.rankers.transformers_similarity.AutoTokenizer.from_pretrained")
    @patch("deepstack.components.rankers.transformers_similarity.AutoModelForSequenceClassification.from_pretrained")
