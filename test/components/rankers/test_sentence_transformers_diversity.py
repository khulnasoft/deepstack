...
from deepstack.components.rankers import SentenceTransformersDiversityRanker
...
class TestSentenceTransformersDiversityRanker:
    ...
    def test_to_dict(self):
        ...
        assert data == {
            "type": "deepstack.components.rankers.sentence_transformers_diversity.SentenceTransformersDiversityRanker",
            "init_parameters": {
    ...
    def test_warm_up(self, similarity, monkeypatch):
        ...
        with patch(
            "deepstack.components.rankers.sentence_transformers_diversity.SentenceTransformer", new=mock_model_class
        ):
