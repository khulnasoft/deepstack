...
from deepstack.dataclasses.answer import Answer, ExtractedAnswer, ExtractedTableAnswer, GeneratedAnswer
...
class TestExtractedAnswer:
    ...
    def test_to_dict(self):
        ...
        assert answer.to_dict() == {
            "type": "deepstack.dataclasses.answer.ExtractedAnswer",
            "init_parameters": {
                "data": "42",
                "query": "What is the answer?",
...
class TestExtractedTableAnswer:
    ...
    def test_to_dict(self):
        ...
        assert answer.to_dict() == {
            "type": "deepstack.dataclasses.answer.ExtractedTableAnswer",
            "init_parameters": {
                "data": "42",
                "query": "What is the answer?",
                "document": document.to_dict(flatten=False),
...
class TestGeneratedAnswer:
    ...
    def test_to_dict(self):
        ...
        assert answer.to_dict() == {
            "type": "deepstack.dataclasses.answer.GeneratedAnswer",
            "init_parameters": {
                "data": "42",
                "query": "What is the answer?",
