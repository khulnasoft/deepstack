...
from deepstack.testing.factory import document_store_class, component_class
...
def test_document_store_class_default():
    ...
    assert store.to_dict() == {"type": "deepstack.testing.factory.MyStore", "init_parameters": {}}


def test_document_store_from_dict():
    MyStore = document_store_class("MyStore")

    store = MyStore.from_dict({"type": "deepstack.testing.factory.MyStore", "init_parameters": {}})
...
def test_component_class_is_registered():
    MyComponent = component_class("MyComponent")
    assert component.registry["deepstack.testing.factory.MyComponent"] == MyComponent
