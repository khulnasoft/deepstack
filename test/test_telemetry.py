...
from deepstack.telemetry._telemetry import pipeline_running
from deepstack.utils.auth import Secret, TokenSecret


@patch("deepstack.telemetry._telemetry.telemetry")
