...
from deepstack.tracing.tracer import (
    NullTracer,
    NullSpan,
    enable_tracing,
    Tracer,
    ...
    auto_enable_tracing,
    tracer,
    DEEPSTACK_CONTENT_TRACING_ENABLED_ENV_VAR,
)
...
class TestAutoEnableTracer:
    ...
    def configured_opentelemetry_tracing(self) -> None:
        resource = Resource(attributes={SERVICE_NAME: "deepstack-testing"})
    ...
    def test_skip_auto_enable_if_tracing_disabled_via_env(
        ...
        monkeypatch.setenv("DEEPSTACK_AUTO_TRACE_ENABLED", "false")
...
class TestTracingContent:
    ...
    def test_set_content_tag_when_enabled_via_env_variable(self, monkeypatch: MonkeyPatch) -> None:
        monkeypatch.setenv(DEEPSTACK_CONTENT_TRACING_ENABLED_ENV_VAR, "true")
