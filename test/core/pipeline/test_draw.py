...
from deepstack.core.errors import PipelineDrawingError
from deepstack.core.pipeline import Pipeline
from deepstack.core.pipeline.draw import _to_mermaid_image, _to_mermaid_text
...
@patch("deepstack.core.pipeline.draw.requests")
...
def test_to_mermaid_image_failing_request(tmp_path):
    ...
    with patch("deepstack.core.pipeline.draw.requests.get") as mock_get:
