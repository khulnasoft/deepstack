...
from deepstack.core.pipeline.template import PipelineTemplate, PredefinedPipeline
...
class TestPipelineTemplate:
    ...
    def test_build_pipeline_with_default_components(self, monkeypatch):
        ...
        with mock.patch("deepstack_integrations.document_stores.chroma.document_store.ChromaDocumentStore"):
