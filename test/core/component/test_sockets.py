...
from deepstack.core.component.sockets import InputSocket, Sockets
...
class TestSockets:
    def test_init(self):
        ...
        assert io.__dict__["input_1"] == comp.__deepstack_input__._sockets_dict["input_1"]
        assert "input_2" in io.__dict__
        assert io.__dict__["input_2"] == comp.__deepstack_input__._sockets_dict["input_2"]
    ...
    def test_getattribute(self):
        comp = component_class("SomeComponent", input_types={"input_1": int, "input_2": int})()
        io = Sockets(component=comp, sockets_dict=comp.__deepstack_input__._sockets_dict, sockets_io_type=InputSocket)

        assert io.input_1 == comp.__deepstack_input__._sockets_dict["input_1"]
        assert io.input_2 == comp.__deepstack_input__._sockets_dict["input_2"]
